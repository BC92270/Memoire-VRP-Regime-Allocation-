...
The machine-learning layer provides a nonlinear test of the incremental information contained in VRP features. Three classifier families are considered: penalized logistic regression, Random Forest, and histogram-based Gradient Boosting. Their role is predictive rather than structural; they do not replace the economic interpretation of the variance premium. This use of flexible prediction methods is consistent with the broader asset-pricing evidence discussed by \textcite{GuKellyXiu2020}.
